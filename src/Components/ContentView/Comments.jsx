...
const Comments = ({article_id, setViewComments, viewComments, commentChange, setCommentChange}) => {
    ...
    return (
        ...
        return <div className="comment" key={comment.comment_id}>
            ...
            <Comment setCommentChange={setCommentChange} user={user} comment_id={comment.comment_id} votesPassed={comment.votes} setViewComments={setViewComments} author={comment.author}/>
            <hr />
        </div>
    }) : null    
    }
